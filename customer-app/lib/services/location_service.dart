...
class LocationService {
  ...
  static Future<DevicePosition?> _resolvePosition() async {
    try {
      // Permission prompts must not compete with startup or appear before the
      // app has painted. `endOfFrame` schedules a frame when called while the
      // scheduler is idle, and completes immediately after that frame.
