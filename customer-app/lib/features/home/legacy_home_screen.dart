...
/// The pre-v2 Home tab: a 470pt hero banner, the beach-cart picker rail, the
/// bottle rail, a featured-cocktail rail and the how-it-works banner.
///
/// **Disconnected, not deleted.** `RootShell` now builds [HomeScreen] from
/// `home_screen.dart` (the context-first redesign). Nothing imports this file;
/// it is kept so the previous Home can be restored or referenced.
