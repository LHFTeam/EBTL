...
import { startForecastScheduler } from './forecast/index.js';
...
// Polls for the Cairo business date rolling over and folds yesterday's sales
// into the demand model. Unref'd like the sweep above, so it never holds the
// process open during shutdown.
const forecastScheduler = startForecastScheduler();
