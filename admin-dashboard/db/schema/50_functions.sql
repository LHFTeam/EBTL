-- EBTL baseline schema — functions in `public`.
--
...
CREATE OR REPLACE FUNCTION public.transition_cart_order_status(p_order_id uuid, p_expected_status order_status, p_next_status order_status)
